...
variable "neptune_policy_name" {
  description = "Name for the Neptune Policy"
  type        = string
}
...
variable "org_neptune_s3_bucket_arn" {
  description = "Org Neptune S3 Bucket ARN"
  type        = string
}

variable "org_neptune_s3_bucket_id" {
  description = "Org Neptune S3 Bucket ID"
  type        = string
}
...
variable "neptune_sagemaker_role_name" {
  description = "Name for the Neptune Sagemaker IAM role"
  type        = string
}

variable "neptune_sagemaker_policy_name" {
  description = "Name for the Neptune Sagemaker Policy"
  type        = string
}
...
variable "neptune_notebook_name" {
  description = "Neptune Notebook Name"
  type        = string
}
